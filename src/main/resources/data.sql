...
INSERT INTO users (
    ...
    active, admin
      ...
      (gen_random_uuid(), 'selkyle', '$2a$10$plRXfUw0I.tZH1mZ2HLV7Or4wJt9ZVKSfamZ/jP0f0Kr0vL3u.r.6', 'MS', NULL, 'Anna', 'Alang', 'Anna.Alang@muster.at', '+43 676 5678901', '6850', 'Dornbirn', 'Austria', 'Marktplatz 3', now(), now(), true, false),
      (gen_random_uuid(), 'parjord', '$2a$10$plRXfUw0I.tZH1mZ2HLV7Or4wJt9ZVKSfamZ/jP0f0Kr0vL3u.r.6', 'MR', NULL, 'Nico', 'Hofer', 'Nico.Hofer@muster.at', '+43 664 6789012', '4400', 'Steyr', 'Austria', 'Stadtplatz 12', now(), now(), true, false),
      (gen_random_uuid(), 'barryv', '$2a$10$plRXfUw0I.tZH1mZ2HLV7Or4wJt9ZVKSfamZ/jP0f0Kr0vL3u.r.6', 'MS', NULL, 'Lisa', 'Gruber', 'Lisa.Gruber@muster.at', '+43 650 7890123', '9500', 'Villach', 'Austria', 'Italiener Straße 25', now(), now(), false, false),
      (gen_random_uuid(), 'reeddoc', '$2a$10$plRXfUw0I.tZH1mZ2HLV7Or4wJt9ZVKSfamZ/jP0f0Kr0vL3u.r.6', 'MR', NULL, 'David', 'Zuccatto', 'David.Zuccatto@muster.at', '+43 699 8901234', '3430', 'Tulln', 'Austria', 'Bahnhofstraße 4', now(), now(), true, false),
      ...
      (gen_random_uuid(), 'tonystar', '$2a$10$plRXfUw0I.tZH1mZ2HLV7Or4wJt9ZVKSfamZ/jP0f0Kr0vL3u.r.6', 'MX', 'was weiß ich', 'Morning', 'Müller', 'Raphael.Müller@muster.at', '+43 664 0123456', '7000', 'Eisenstadt', 'Austria', 'Haydngasse 11', now(), now(), true, false),
      (gen_random_uuid(), 'steverog', '$2a$10$plRXfUw0I.tZH1mZ2HLV7Or4wJt9ZVKSfamZ/jP0f0Kr0vL3u.r.6', 'MS', NULL, 'Theresa', 'Chang', 'Theresa.Chang@muster.at', '+43 650 1234567', '1190', 'Wien', 'Austria', 'Grinzinger Straße 14', now(), now(), true, false),
      (gen_random_uuid(), 'natroma', '$2a$10$plRXfUw0I.tZH1mZ2HLV7Or4wJt9ZVKSfamZ/jP0f0Kr0vL3u.r.6', 'MR', NULL, 'Simon', 'Schuster', 'Simon.Schuster@muster.at', '+43 699 2345678', '9560', 'Feldkirchen', 'Austria', 'Hauptplatz 9', now(), now(), true, true),
      (gen_random_uuid(), 'bamwayne', '$2a$10$plRXfUw0I.tZH1mZ2HLV7Or4wJt9ZVKSfamZ/jP0f0Kr0vL3u.r.6', 'MS', NULL, 'Nina', 'Wiener', 'Nina.Wiener@muster.at', '+43 676 3456789', '2500', 'Baden', 'Austria', 'Helenenstraße 6', now(), now(), true, false);
